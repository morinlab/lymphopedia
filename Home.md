...
Each gene is [categorized](#Categorization) based on the level and quality of supporting data in the original study and other comparable datasets. Details for each gene can be found on their respective pages. The novel genes nominated by each study can be found on the study-centric pages.
